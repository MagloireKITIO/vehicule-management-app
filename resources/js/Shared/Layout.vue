<template>
  <div>
    <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
      <div class="container">
        <inertia-link class="navbar-brand" href="/">vehiculeApp</inertia-link>
        <button
          ...
          <ul class="navbar-nav mr-auto">
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownLeft">
                <inertia-link :href="$route('lead.list')" class="dropdown-item">vehicule</inertia-link>
<!--                <inertia-link :href="$route('subscribers.list')" class="dropdown-item">Notification</inertia-link>-->
